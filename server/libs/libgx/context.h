...
public:
    ...
    virtual bool db_begin() noexcept {
        return true;
    }
    virtual bool db_commit() noexcept {
        return true;
    }
    virtual void db_rollback() noexcept { }
    ...
    void call_result(int result) noexcept {
        _call_result = result;
    }
...
inline Context *the_context() noexcept {
